...
**Trạng thái "Đã lên lịch"** (chưa bắt đầu):
...
#### 2.5a. Manual Creation Modal (Tạo thủ công)
...
**Bước 4: Edit Individual Session (từ preview)**
...
- Hiển thị **Avatar** học sinh (hình vuông bo góc 40x40px):
